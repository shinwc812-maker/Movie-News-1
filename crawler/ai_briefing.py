"""AI 브리핑 생성 — claude -p로 호출하여 추가 비용 없이 진행.
...
PROMPT_INSTRUCTION = """당신은 롯데컬처웍스 컨텐츠사업부에 매일 아침 영화·문화 산업 동향을 보고하는 분석가입니다. 아래 JSON 데이터(KOBIS 박스오피스, 수집 기사, 커뮤니티 반응, 시장동향, 정책)를 토대로 '오늘의 AI 브리핑'을 작성하세요.
...
new_trends/industry_signals은 market_trends·articles에서 의사결정에 유의미한 것만 각 2~4개.
"""
